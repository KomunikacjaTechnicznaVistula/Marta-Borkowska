...
W aplikacji możesz wybrać spośród wielu aktywności sportowych:
   ...
   * wyścigi (_races_)
      ...
      * czasowe (_time trial - TT_)   
      ...
      Wyboru możesz dokonać w aplikacji _Zwift Companion_ (większy wybór) lub na Zwifcie (_Upcoming events_). Uwaga: należy wybrać wyścig zgodnie z własną [kategorią]({% link /docs/../../Glosariusz.md). W przeciwnym razie grozi dyskwalifikacja!
